...
<title>Nueva reserva — Lima América Tours</title>
</head>
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#fffdf9;border-radius:18px;overflow:hidden;border:1px solid #eee3d4;border-top:6px solid #d99a32;">
    ...
    {{-- Marca --}}
    <tr><td style="background:linear-gradient(135deg,#cb101e,#9d0c16);background-color:#cb101e;padding:20px;text-align:center;color:#fff;font-family:Georgia,serif;font-size:21px;letter-spacing:6px;font-weight:bold;">
    ...
    <tr><td style="background:#073b3d;color:#fff;padding:16px;text-align:center;font-size:12px;">
        Aviso interno automático <span style="color:#dca03a;margin:0 8px;">|</span> Lima América Tours
    </td></tr>
