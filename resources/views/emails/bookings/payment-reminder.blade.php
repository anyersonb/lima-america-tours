...
<title>{{ $L('Recordatorio de pago', 'Payment reminder') }} — Lima América Tours</title>
</head>
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#fffdf9;border-radius:18px;overflow:hidden;border:1px solid #eee3d4;">
    ...
    {{-- Marca --}}
    <tr><td style="background:linear-gradient(135deg,#cb101e,#9d0c16);background-color:#cb101e;padding:22px;text-align:center;color:#fff;">
