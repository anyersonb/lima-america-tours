...
<title>{{ $L('Tu cuenta en Lima América Tours', 'Your Lima América Tours account', 'Sua conta na Lima América Tours') }}</title>
</head>
...
<div style="display:none;max-height:0;overflow:hidden;opacity:0;">
    {{ $L('Tus credenciales de acceso a Lima América Tours', 'Your Lima América Tours login credentials', 'Suas credenciais de acesso à Lima América Tours') }}
</div>
...
<table role="presentation" width="600" cellpadding="0" cellspacing="0" style="width:600px;max-width:100%;background:#fffdf9;border-radius:18px;overflow:hidden;border:1px solid #eee3d4;">
    ...
    {{-- Brand header --}}
    <tr><td style="background:linear-gradient(135deg,#cb101e,#9d0c16);background-color:#cb101e;padding:22px;text-align:center;color:#fff;font-family:Georgia,serif;font-size:22px;letter-spacing:6px;font-weight:bold;">
        <img src="{{ asset('assets/logos/logo-america-white.webp') }}" alt="Lima América Tours" width="180" height="89" style="width:180px;height:auto;display:inline-block;border:0;">
