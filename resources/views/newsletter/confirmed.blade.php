    ...
    <div class="container mx-auto px-5 text-center max-w-xl">
        ...
        @if($locale === 'en')
            ...
            <p class="mt-4 text-teal-800/75">
                You are now subscribed to the Lima América Tours newsletter. Get ready to discover the best of Peru!
            </p>
        ...
        @else
            ...
            <p class="mt-4 text-teal-800/75">
                Ya estás suscrito al boletín de Lima América Tours. ¡Prepárate para descubrir lo mejor del Perú!
            </p>
