 ...
 *   Ica, Nazca, Lima América Tours, Sacsayhuamán, Barranco, Ballestas.
 */
class TranslateHomeContentSeeder extends Seeder
{
    ...
    private array $simpleTexts = [
        ...
        'home_sec_why_title' => [
            'en' => 'Why choose<br>Lima América Tours?',
            'pt' => 'Por que escolher<br>a Lima América Tours?',
        ],
    ...
    private function faqsArray(): array
    {
        return [
            ...
            [
                'q_es'     => '¿Es seguro viajar con Lima América Tours?',
                'q_en'     => 'Is it safe to travel with Lima América Tours?',
                'q_pt'     => 'É seguro viajar com a Lima América Tours?',
