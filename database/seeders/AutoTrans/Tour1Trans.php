...
Por favor, certifique-se de nos fornecer o endereço do seu hotel no momento da reserva para que possamos coordenar os detalhes do traslado e garantir uma experiência sem contratempos.',
            'itinerary_en' => json_encode([
                ...
                ['time' => '6:30 am', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-2.jpg', 'description' => 'We will make a brief stop to have breakfast'],
                ['time' => '9:00 am', 'image' => 'tours/OASIS-DE-HUACACHINA-ISLAS-BALLESTAS-EN-PARACAS-2.jpg', 'description' => 'Ballestas Islands — arrival at the tourist pier where we will begin our excursion to the Ballestas Islands. During this trip we will take a boat ride, where you will be able to admire El Candelabro, a large-scale geoglyph very similar to the Nazca Lines. These islands are made up of natural rock formations that shelter an important marine fauna, home to large colonies of guano birds (Guanay cormorant, Peruvian booby, Pelican, Cormorant, Inca terns, etc.). We will also be able to spot Sea Lions, Humboldt Penguins and, with a bit of luck, Dolphins.'],
                ['time' => '1:00 pm', 'image' => 'tours/OASIS-DE-HUACACHINA-ISLAS-BALLESTAS-EN-PARACAS-4.jpg', 'description' => 'Lunch — we arrive in Ica for lunch (free time). We can enjoy some typical local dishes such as "La Ruta del Pisco", duck rice, sopa seca, ceviche, and other specialties.'],
                ['time' => '2:00 pm', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-3.jpg', 'description' => 'Winery visit and tasting (Bodega Nieto) — we will tour the winery to learn about the production of fine pisco, followed by a tasting of wines, pisco creams, macerados, and pisco, all already included in our service. Those who wish may purchase additional items.'],
                ['time' => '3:00 pm', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-4.jpg', 'description' => 'Visit to the Huacachina Oasis and Dunes — we will discover the thrill of Huacachina! A one-of-a-kind experience at the largest oasis in South America.'],
                ['time' => 'Buggies in the desert', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-5.jpg', 'description' => 'We will experience the excitement of riding the dunes in our off-road vehicles, driven by expert drivers who will take you across the sand dunes at full speed to enjoy breathtaking panoramic views.'],
                ['time' => 'Sandboarding', 'image' => 'tours/OASIS-DE-HUACACHINA-ISLAS-BALLESTAS-EN-PARACAS-5.jpg', 'description' => 'We will conquer the dunes with our sandboarding equipment and glide down the slopes on a board specially designed for sand — an exhilarating experience you simply cannot miss.'],
                ['time' => '6:00 pm', 'image' => 'tours/2024-02-barranco-timeout.jpg', 'description' => 'Return to Lima'],
            ...
            'itinerary_pt' => json_encode([
                ...
                ['time' => '6:30 am', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-2.jpg', 'description' => 'Faremos uma breve parada para tomar café da manhã'],
                ['time' => '9:00 am', 'image' => 'tours/OASIS-DE-HUACACHINA-ISLAS-BALLESTAS-EN-PARACAS-2.jpg', 'description' => 'Ilhas Ballestas — chegada ao píer turístico, onde iniciaremos nossa excursão às Ilhas Ballestas. Neste percurso faremos um passeio de lancha, onde poderão admirar El Candelabro, um geoglifo de grandes dimensões muito semelhante às Linhas de Nazca. Essas ilhas são formadas naturalmente por formações rochosas que abrigam uma importante fauna marinha, com grandes colônias de aves guaneiras (Guanay, Piquero, Pelicano, Cormorão, Gaivota-de-inca, etc.). Também poderemos avistar leões-marinhos, pinguins de Humboldt e, com um pouco de sorte, golfinhos.'],
                ['time' => '1:00 pm', 'image' => 'tours/OASIS-DE-HUACACHINA-ISLAS-BALLESTAS-EN-PARACAS-4.jpg', 'description' => 'Almoço — chegamos a Ica para almoçar (tempo livre). Poderemos desfrutar de alguns pratos típicos como "La Ruta del Pisco", arroz com pato, sopa seca, ceviche e outras especialidades.'],
                ['time' => '2:00 pm', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-3.jpg', 'description' => 'Visita à vitivinícola e degustação (Bodega Nieto) — faremos um tour pela adega para conhecer a elaboração de um bom pisco, seguido de degustação de vinhos, cremes de pisco, macerados e pisco, tudo já incluído no serviço. Quem desejar poderá comprar.'],
                ['time' => '3:00 pm', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-4.jpg', 'description' => 'Visita ao Oásis Huacachina e Dunas — vamos descobrir a emoção de Huacachina! Uma experiência única no maior oásis da América do Sul.'],
                ['time' => 'Buggies no deserto', 'image' => 'tours/OASIS-DE-HUACACHINA-CON-BUGGIE-5.jpg', 'description' => 'Viveremos a emoção de percorrer as dunas em nossos veículos off-road, conduzidos por motoristas experientes que levarão você pelas dunas de areia em alta velocidade para desfrutar de vistas panorâmicas deslumbrantes.'],
                ['time' => 'Sandboarding', 'image' => 'tours/OASIS-DE-HUACACHINA-ISLAS-BALLESTAS-EN-PARACAS-5.jpg', 'description' => 'Dominaremos as dunas com nosso equipamento de sandboarding e desceremos pelas encostas em uma prancha especialmente projetada para a areia — sem dúvida uma experiência emocionante que você não pode perder.'],
                ['time' => '6:00 pm', 'image' => 'tours/2024-02-barranco-timeout.jpg', 'description' => 'Retorno a Lima'],
