        ...
        $data = [
            ...
            'itinerary_en' => json_encode([
                ...
                [
                    ...
                    'image' => null,
                    'description' => 'Departure from Cusco to the train station in Ollantaytambo, then continue by train to Aguas Calientes. From there, take the bus up to Machu Picchu and enjoy a guided tour of the citadel lasting approximately 2 to 3 hours. Afterwards, free time for photos and to soak in the surroundings before the bus and train return to Cusco. At Lima América Tours, this tour includes train, bus, Machu Picchu entrance and professional guide. Overnight in Cusco. (3-STAR HOTEL INCLUDED)',
                ],
                [
