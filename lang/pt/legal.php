...
return [
    ...
    'terms_s3_body'  => 'As reservas são confirmadas somente após o recebimento do pagamento total ou de um depósito de 50% do valor do tour, conforme indicado em cada oferta. O pagamento pode ser realizado com cartão de crédito/débito (Visa, Mastercard, American Express) por meio de nossa plataforma de pagamentos segura Culqi. A Lima América Tours não armazena dados de cartões; o processamento é gerenciado integralmente pelo provedor de pagamento certificado.',

    'terms_s4_title' => 'Cancelamentos e Reembolsos',
    'terms_s4_body'  => 'Os cancelamentos realizados com mais de 48 horas de antecedência à data do tour receberão reembolso de 80% do valor pago. Os cancelamentos efetuados entre 24 e 48 horas antes terão direito a reembolso de 50%. Não haverá reembolso por cancelamentos com menos de 24 horas de antecedência nem por ausências no ponto de partida. Em casos de força maior (desastres naturais, greves, restrições governamentais), será oferecida remarcação sem custo adicional.',

    'terms_s5_title' => 'Contato',
    'terms_s5_body'  => 'Para qualquer dúvida relacionada a estes termos, você pode entrar em contato conosco pelo formulário em nossa página de contato, por e-mail ou ligando para +51 935 542 384. Nossa equipe atende de segunda a domingo das 9:00 a.m. às 6:30 p.m. (GMT-5). Lima América Tours — Jr. Lampa 209, Lima Center, Lima, Peru.',

    // Privacy sections
    'privacy_s1_title' => 'Dados que Coletamos',
    'privacy_s1_body'  => 'A Lima América Tours coleta apenas os dados estritamente necessários para prestar nossos serviços. Isso inclui: nome completo, e-mail e número de telefone ao realizar uma reserva ou assinar a newsletter; dados de navegação anônimos (cookies de análise) para melhorar a experiência do usuário; e informações de pagamento que são processadas diretamente pela Culqi e não são armazenadas em nossos servidores.',
    ...
    'privacy_s3_body'  => 'A Lima América Tours não vende, aluga nem comercializa suas informações pessoais a terceiros. Compartilhamos dados apenas com fornecedores operacionais indispensáveis (plataforma de pagamento Culqi, serviço de envio de e-mails transacionais) que se comprometem contratualmente a tratar os dados com o mesmo nível de proteção. Podemos divulgar informações quando exigido por lei ou para proteger nossos direitos legais.',
    ...
    'privacy_s5_body'  => 'Em conformidade com a Lei N.° 29733 de Proteção de Dados Pessoais do Peru, você tem o direito de acessar, retificar, cancelar ou se opor ao tratamento de seus dados pessoais. Para exercer esses direitos, envie uma solicitação por escrito para nosso e-mail ou endereço físico (Jr. Lampa 209, Lima Center). Responderemos em um prazo máximo de 20 dias úteis.',
];
