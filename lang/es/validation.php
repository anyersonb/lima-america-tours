...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de los mensajes de validación por defecto de
    | Laravel. Se usa en el panel de administración (Filament) y en los
    | Form Requests del frontend público. El locale de la app es "es" por
    | defecto (config/app.php), así que este archivo evita que Laravel caiga
    | al inglés del framework (vendor) cuando app()->getLocale() === 'es'.
    |
    */
